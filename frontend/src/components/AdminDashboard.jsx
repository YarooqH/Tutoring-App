...
<div className="flex flex-col text-center w-full mb-12">
  <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Going on Tutions</h1>
  <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Admin Panel for Tutions.</p>
</div>
...
<div className="flex flex-wrap m-4">
  ...
  <div key={post.id} className="xl:w-1/3 md:w-1/2 p-4">
    <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg">
      ...
      <p className="leading-relaxed text-base font-medium text-white my-5">Tution Fees: {'Rs. ' + post.tutionFees}</p>
