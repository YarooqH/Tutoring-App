    ...
    <div className="flex flex-wrap m-4">
      <div className="xl:w-1/3 md:w-1/2 p-4">
        <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg">
          <h2 className="text-lg text-white font-medium title-font mb-2">Mr. John Smith</h2>
          <p className="leading-relaxed text-base">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cumque quasi voluptates, sapiente architecto praesentium modi!</p>
